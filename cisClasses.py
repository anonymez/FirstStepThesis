def cis_3_3(option, syslogServer=str):
...
class cisControl:
    ...
    def cis_2_5(self, host, used=False, maxTrap=int(0)):
        ...
        if not configuration and not used:
            cis_2_5_passed = True
        elif configuration and used:
    ...
    def cis_4_3(self, host, domain=''):
        ...
        for authInfo in activeDomain.authConfig:
            if 'ActiveDirectoryInfo' in authInfo.__class__.__name__ and authInfo.enabled:
                cis_4_3_passed = True
    ...
    def cis_6_1(self, storage):
        ...
        for s in storageFolder:
            if s.__class__.__name__ == 'vim.host.InternetScsiHba':
                ...
                if (chapCap.chapAuthSettable  and chapCap.mutualChapSettable
                        and chapProp.chapAuthEnabled and chapProp.chapName != ''
    ...
    def cis_7_1(self, portGroup):
        ...
        if not forgedTransmit.forgedTransmits:
            cis_7_1_passed = True
    ...
    def cis_7_2(self, portGroup):
        ...
        if not macAddresChange.macChanges:
            cis_7_2_passed = True
    ...
    def cis_7_3(self, portGroup):
        ...
        if not promiscuousMode.allowPromiscuous:
            cis_7_3_passed = True
